...
#define QT_MOC_LITERAL(ofs, len) \
    uint(offsetof(qt_meta_stringdata_Jefe_final_t, stringdata0) + ofs), len 
static const qt_meta_stringdata_Jefe_final_t qt_meta_stringdata_Jefe_final = {
    {
QT_MOC_LITERAL(0, 10), // "Jefe_final"
QT_MOC_LITERAL(11, 10), // "Mover_Jefe"
QT_MOC_LITERAL(22, 0) // ""

    },
    "Jefe_final\0Mover_Jefe\0"
};
...
void Jefe_final::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        auto *_t = static_cast<Jefe_final *>(_o);
        (void)_t;
        switch (_id) {
        case 0: _t->Mover_Jefe(); break;
        default: ;
        }
    }
    (void)_a;
...
const QMetaObject Jefe_final::staticMetaObject = { {
    QMetaObject::SuperData::link<Enemigos::staticMetaObject>(),
    qt_meta_stringdata_Jefe_final.offsetsAndSize,
    qt_meta_data_Jefe_final,
    qt_static_metacall,
    nullptr,
qt_incomplete_metaTypeArray<qt_meta_stringdata_Jefe_final_t
, QtPrivate::TypeAndForceComplete<Jefe_final, std::true_type>
